...
public partial class Paginas_InstalarDispositivo : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "VER")
        {
            ...
            if (GridView1.Rows[index].Cells[1].Text.Trim() != "En Proceso")
            {
                ScriptManager.RegisterClientScriptBlock(Page, GetType(), "mensaje", "js_MostrarAlertaAtencion('Instalar Dispositivo', 'Estado incorrecto');", true);
                return;
            }
